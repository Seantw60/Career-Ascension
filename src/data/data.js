...
export const skillsData = [
  ...
  { id: 0, name: "SQL", power: 3, points: 2, type: "hard", cooldown: 3, description: "Extract and analyze insights from databases." },
  { id: 1, name: "Debugging", power: 2, points: 2, type: "hard", cooldown: 1, description: "Find and fix issues efficiently." },
  { id: 2, name: "React", power: 3, points: 2, type: "hard", cooldown: 3, description: "Build responsive UIs with reusable components." },
  { id: 3, name: "Python", power: 3, points: 3, type: "hard", cooldown: 2, description: "Write powerful scripts to process data fast." },
  { id: 4, name: "Excel", power: 2, points: 3, type: "hard", cooldown: 2, description: "Analyze data and create reports efficiently." },
  { id: 5, name: "Problem Solving", power: 3, points: 3, type: "hard", cooldown: 2, description: "Break down complex problems and produce solutions." },
  { id: 6, name: "JavaScript", power: 2, points: 3, type: "hard", cooldown: 2, description: "Create interactive web features and logic." },
  { id: 7, name: "Data Visualization", power: 2, points: 3, type: "hard", cooldown: 2, description: "Present data clearly using charts and visuals." },
  { id: 8, name: "Git", power: 1, points: 4, type: "hard", cooldown: 1, description: "Manage source control and collaborate on code." },

  /* === SOFT SKILLS (points: low -> high) === */
  { id: 9, name: "Leadership", power: 2, points: 2, type: "soft", cooldown: 2, description: "Guide teams and make strategic decisions." },
  { id: 10, name: "Presentation", power: 1, points: 2, type: "soft", cooldown: 1, description: "Deliver ideas clearly to groups and stakeholders." },
